...
import com.prograngers.backend.dto.review.response.CodeLineWithReviewsResponse;
...
public class ReviewService {
    ...
    public ShowReviewsResponse getReviewDetail(Long solutionId, Long memberId) {
        ...
        List<CodeLineWithReviewsResponse> addedCodeLineResponsWithReviews = showReviewsResponse.getCodeLineWithReviewsRespons();
        addReviewAtLine(addedCodeLineResponsWithReviews, memberId);
        showReviewsResponse.setCodeLineWithReviewsRespons(addedCodeLineResponsWithReviews);
    ...
    private void addReviewAtLine(List<CodeLineWithReviewsResponse> addedCodeLineResponsWithReviews, Long memberId) {
        // 라인들에 대해 for문을 돌면서 리뷰를 추가한다
        for (CodeLineWithReviewsResponse codeLineWithReviewsResponse : addedCodeLineResponsWithReviews) {
            Integer codeLineNumber = codeLineWithReviewsResponse.getCodeLineNumber();
            ...
            codeLineWithReviewsResponse.setReviewWithRepliesRespons(reviewResponseWithRepliesResponse);
        }
    }
