...
import static com.prograngers.backend.support.fixture.MemberFixture.길가은2;
...
import static com.prograngers.backend.support.fixture.SolutionFixture.풀이3;
...
class SolutionRepositoryTest {
    ...
    void 저장_테스트() {
        ...
        //then
        assertThat(saved).isEqualTo(solution);
    }
