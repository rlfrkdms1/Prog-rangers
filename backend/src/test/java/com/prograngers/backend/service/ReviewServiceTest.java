...
class ReviewServiceTest {
    ...
    void 내_리뷰_아닌_리뷰_수정_삭제_시_예외(){
        ...
        // when then
        assertAll(
                ()-> assertThrows(MemberUnAuthorizedException.class,()->reviewService.updateReview(리뷰_수정_요청_생성(),2L,1L)),
    ...
    void 삭제된_리뷰_수정_삭제_시_예외(){
        ...
        // when then
        assertAll(
                ()-> assertThrows(ReviewAlreadyDeletedException.class,()->reviewService.updateReview(리뷰_수정_요청_생성(),1L,1L)),
