    ...
    `}>
      ...
      <div css={css`${MainBody}`}>
        ...
        <div className="filter"
          css={css`${filterStyle}`}>
            <FilterBar2 title="language" options={sort.LANGUAGE} onSelect={handleLanguageChange} />
            <FilterBar2 title="algorithm" options={sort.ALGORITHM} onSelect={handleAlgorithmChange} />
            <FilterBar2 title="datastructure" options={sort.DATASTRUCTURE} onSelect={handleDataStructureChange} />
            <FilterBar2 title="level" options={sort.LEVEL} onSelect={handleLevelChange} />
        </div>
