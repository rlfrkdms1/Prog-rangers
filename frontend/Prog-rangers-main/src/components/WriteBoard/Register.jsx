    ...
    <div>
      ...
      >
        <div className="header" css={css`display: flex; flex-direction: row; justify-content: space-between; align-items: flex-end;`}>
          <div css={css`${TitleBox}`}>문제 제목</div>
        ...
        <input placeholder="문제 제목을 입력해주세요" css={css`${StyledInput}`} value={inputs.question} name="question" onChange={handleInput}/>
        
        <div css={css`${TitleBox} margin-top: 50px;`}>풀이 제목</div>
