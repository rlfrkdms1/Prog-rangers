...
export const RecommendFollow = () => {
  ...
  const [recommendedAccounts, setRecommendedAccounts] =
    useState(data.recommends);
  const handleFollowClick = (item) => {
    ...
    fetch(
      ...
      .then((response) => {
        ...
        updatedFollowStatus[memberId] =
          !followStatus[memberId];
    ...
    const isAlreadyFollowed = followedAccounts.some(
    ...
    const updatedRecommendedAccounts =
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <div
                  onClick={() => onClickName(item.nickname)}
                  css={css`
                    ${fontSize12} cursor: pointer;
                  `}
                >
                  {item.nickname}
                </div>
                ...
                >
                  ...
                  <button
                    ...
                    css={css`
                      ${buttonSytle} background-color:${followStatus[
                        item.id
                      ]
                        ? theme.colors.light2
                        : theme.colors.main30}
